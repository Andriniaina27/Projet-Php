        ...
        <main role="main" class="col-md-10 ml-sm-auto px-4 ">
            <div class="container-fluid p-top">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <form action="../models/updateAnnonce.php" method="post">
                            <div class="row">
                            <input type="hidden" name="id_an" class="form-control" value="<?= $row['id'];?>">
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea name="description" class="form-control" id="" cols="10" rows="3"><?= $row['description'];?></textarea>
                                    <p></p>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="file" name="images" class="form-control" value="<?= $row['titre'];?>">
                                    <p></p>
                                </div>
                                <div class="col-md-12">
